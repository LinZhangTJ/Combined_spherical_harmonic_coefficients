...
1. cs: Combined spherical harmonic coefficients (without GIA correction, no C20 and C30 replacement, no degree-1 coefficients added back) [geoid coefficients (gc)]

2. cs_sig: Uncertainty of cs

3. TWSA (cm): Grids converted from cs with the following corrections:
...
(5）geoid coefficients (gc) to mass coefficients (mc)
